                            ...
                            {!! Form::model($customer,['route'=>['customer-update',$customer->id],'class'=>'form-horizontal','method'=>'put','role'=>'form']) !!}
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <div class="input-group">
                                                <input name="fname" class="form-control bold" value="{{ $customer->fname }}" placeholder="Father Name" required/>
                                                <span class="input-group-addon"><strong><i class="fa fa-file-text-o"></i></strong></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <div class="input-group">
                                                <input name="cnic" class="form-control bold" value="{{ $customer->cnic }}" placeholder="CNIC" required/>
                                                <span class="input-group-addon"><strong><i class="fa fa-file-text-o"></i></strong></span>
                                            </div>
                                        </div>
                                    </div>
